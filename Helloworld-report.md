...
helloWorld(): This function doe snot need arguments and returns a string "Hello World".

setText: This function sets a new value for the text variable that is private to the contract. You need to provide newText argument is declared as type string 
...
transferOwnership: This function transfer contract ownership to a new given address as an argument. This function works in parallel with the modifier onlyOwner() which 
